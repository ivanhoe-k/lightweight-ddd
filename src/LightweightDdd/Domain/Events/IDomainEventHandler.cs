...
namespace LightweightDdd.Domain.Events
{
    ...
    public interface IDomainEventHandler
    {
        ...
        /// </returns>
        Result<IDomainError, IReadOnlyCollection<IDomainEffect>> Handle(IDomainEvent @event);
    }
        ...
        where TEvent : IDomainEvent
    {
        ...
        /// A <see cref="Result{TError, TValue}"/> containing either an error or a collection of resulting domain effects.
        /// </returns>
        Result<IDomainError, IReadOnlyCollection<IDomainEffect>> Handle(TEvent @event);
    }
}
