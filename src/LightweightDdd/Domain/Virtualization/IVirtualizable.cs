...
namespace LightweightDdd.Domain.Virtualization
{
        ...
        where TKey : IComparable<TKey>
    {
        ...
        /// virtual entity or an <see cref="IDomainError"/> indicating the reason for failure.
        /// </returns>
        static abstract Result<IDomainError, TVirtual> CreateVirtual(Guid id, long version, TVirtualArgs args);
    }
}
